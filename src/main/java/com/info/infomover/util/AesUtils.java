...
public class AesUtils {
    ...
    public static String wrappeDaesDecrypt(String encrypt) {

        if (StringUtils.isEmpty(encrypt)) {
//            throw new RuntimeException("encrypt str is Empty");
            return null;
        }

        if (StringUtils.isNotEmpty(encrypt) && !encrypt.startsWith(prefix)) {
            return encrypt;
        }
        try {
            return aesDecrypt(unwrapEncryptedValue(encrypt), KEY);
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
    }
    public static String unwrapEncryptedValue(String ciphertext) {
